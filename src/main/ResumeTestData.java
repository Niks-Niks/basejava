...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.addSection(SectionType.EDUCATION, new OrganizationSection(new Organization("Title", new Organization.Link("link", "name"),
                new Organization.Place(LocalDate.of(2019, 8, 18), LocalDate.of(2020, 8, 18), "description"),
                new Organization.Place(LocalDate.of(2019, 8, 18), LocalDate.of(2020, 8, 18), "description"))));
        ...
        resume.addSection(SectionType.EXPERIENCE, new OrganizationSection(new Organization("Title", new Organization.Link("link", "name"),
                new Organization.Place(LocalDate.of(2019, 8, 18), LocalDate.of(2020, 8, 18), "description"),
                new Organization.Place(LocalDate.of(2019, 8, 18), LocalDate.of(2020, 8, 18), "description"))));
